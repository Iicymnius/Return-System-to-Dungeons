...
state start begin
	...
	when login begin
		if pc.get_map_index() >= 3520000 and pc.get_map_index() < 3530000 then
			...
			pc.setqf("dungeonorgindex",352)
			pc.setqf("dungeon_ch",pc.get_channel_id())
			d.set_warp_location (0, 0, 0)
		end
	end

	when 20395.chat."Kaldýðýn Yerden Devam Et" with d.find(pc.get_dungeonindex()) begin
		if pc.getqf("dungeonorgindex") != 352 then
		...
		local oldumu = d.getf_from_map_index("nemere_dead", n)
		local levelnemere = d.getf_from_map_index("levelnemere", n)
		if levelnemere < 1 then
			say("1. kata gelmediðin için giriþ yapamazsýn.")
			return
		end

		if oldumu == 1 then
			say_npc()
			say("Nemereyi zaten yok etmiþsin.")
			return
		end
		if n == 0 then
			setskin(NOWINDOW)
		...
		if levelnemere == 1 then
			say_npc()
			say("Görünüþe göre 1. katta nemereden ayrýldýn, sana yardýmcý olmak istiyorum.")
			say_sari("Nemereye devam etmek istiyor musun?")
			if select(locale.yes,locale.no) == 1 then
				pc.setqf("dungeon_enter",1)
				pc.warp((special.nemere_dungeon[1][1] + 5120 )* 100, (special.nemere_dungeon[1][2] + 1536) * 100,n)
			end
		end
		if levelnemere == 2 then
			say_npc()
			say("Görünüþe göre 2. katta nemereden ayrýldýn, sana yardýmcý olmak istiyorum.")
			say_sari("Nemereye devam etmek istiyor musun?")
			if select(locale.yes,locale.no) == 1 then
				pc.setqf("dungeon_enter",1)
				pc.warp((special.nemere_dungeon[2][1] + 5120 )* 100, (special.nemere_dungeon[2][2] + 1536) * 100,n)
			end
		end
		if levelnemere == 3 then
			say_npc()
			say("Görünüþe göre 3. katta nemereden ayrýldýn, sana yardýmcý olmak istiyorum.")
			say_sari("Nemereye devam etmek istiyor musun?")
			if select(locale.yes,locale.no) == 1 then
				pc.setqf("dungeon_enter",1)
				pc.warp((special.nemere_dungeon[3][1] + 5120 )* 100, (special.nemere_dungeon[3][2] + 1536) * 100,n)
			end
		end
		if levelnemere == 4 then
			say_npc()
			say("Görünüþe göre 4. katta nemereden ayrýldýn, sana yardýmcý olmak istiyorum.")
			say_sari("Nemereye devam etmek istiyor musun?")
			if select(locale.yes,locale.no) == 1 then
				pc.setqf("dungeon_enter",1)
				pc.warp((special.nemere_dungeon[4][1] + 5120 )* 100, (special.nemere_dungeon[4][2] + 1536) * 100,n)
			end
		end
		if levelnemere == 5 then
			say_npc()
			say("Görünüþe göre 5. katta nemereden ayrýldýn, sana yardýmcý olmak istiyorum.")
			say_sari("Nemereye devam etmek istiyor musun?")
			if select(locale.yes,locale.no) == 1 then
				pc.setqf("dungeon_enter",1)
				pc.warp((special.nemere_dungeon[5][1] + 5120 )* 100, (special.nemere_dungeon[5][2] + 1536) * 100,n)
			end
		end
		if levelnemere == 6 then
			say_npc()
			say("Görünüþe göre 6. katta nemereden ayrýldýn, sana yardýmcý olmak istiyorum.")
			say_sari("Nemereye devam etmek istiyor musun?")
			if select(locale.yes,locale.no) == 1 then
				pc.setqf("dungeon_enter",1)
				pc.warp((special.nemere_dungeon[6][1] + 5120 )* 100, (special.nemere_dungeon[6][2] + 1536) * 100,n)
			end
		end
		if levelnemere == 7 then
			say_npc()
			say("Görünüþe göre 7. katta nemereden ayrýldýn, sana yardýmcý olmak istiyorum.")
			say_sari("Nemereye devam etmek istiyor musun?")
			if select(locale.yes,locale.no) == 1 then
				pc.setqf("dungeon_enter",1)
				pc.warp((special.nemere_dungeon[7][1] + 5120 )* 100, (special.nemere_dungeon[7][2] + 1536) * 100,n)
			end
		end
		if levelnemere == 8 then
			say_npc()
			say("Görünüþe göre 8. katta nemereden ayrýldýn, sana yardýmcý olmak istiyorum.")
			say_sari("Nemereye devam etmek istiyor musun?")
			if select(locale.yes,locale.no) == 1 then
				pc.setqf("dungeon_enter",1)
				pc.warp((special.nemere_dungeon[8][1] + 5120 )* 100, (special.nemere_dungeon[8][2] + 1536) * 100,n)
			end
		end
		if levelnemere == 9 then
			say_npc()
			say("Görünüþe göre 9. katta nemereden ayrýldýn, sana yardýmcý olmak istiyorum.")
			say_sari("Nemereye devam etmek istiyor musun?")
			if select(locale.yes,locale.no) == 1 then
				pc.setqf("dungeon_enter",1)
				pc.warp((special.nemere_dungeon[9][1] + 5120 )* 100, (special.nemere_dungeon[9][2] + 1536) * 100,n)
			end
		end
		if levelnemere == 10 then
			say_npc()
			say("Görünüþe göre 10. katta nemereden ayrýldýn, sana yardýmcý olmak istiyorum.")
			say_sari("Nemereye devam etmek istiyor musun?")
			if select(locale.yes,locale.no) == 1 then
				pc.setqf("dungeon_enter",1)
				pc.warp((special.nemere_dungeon[10][1] + 5120 )* 100, (special.nemere_dungeon[10][2] + 1536) * 100,n)
			end
		end
	end
    ...
    when 20397.chat."Zindani Canlandir !" with d.getf("level") == 0 begin --Eisiger Löwe
		...
		say("çýktýðýnda iki saat bekledikten sonra tekrar")
		say("girebilirsin.")
		wait()	
            local set = snow_dungeon.get_settings()
    ...
    when kill begin
        if snow_dungeon.is_nemeres_dungeon() == true then
            ...
            elseif level == 10 and mobvnum == boss_vnum then
				...
				d.notice("ýþýnlanacaksýnýz.")
				notice_all("|cff00ff00"..pc.get_name().." grubu, Nemere Kesmiþtir! ")
